<%-- 
    Document   : disenioActividad2
    Created on : 17/02/2015, 06:59:35 AM
    Author     : felix
--%>
...
<html>
    <head>
        ...
        <title>Diseño de Actividad</title>
            ...
            <form>
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <a href="/SistemaEvaluacion/disenioActividad3.jsp?etapa=<%=materias_vector.get(i)%>&materia=<%=Materia.getMateriaNombre(Integer.parseInt(request.getParameter("materia")))%>">
