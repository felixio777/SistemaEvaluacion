<%-- 
    Document   : disenioActividad1
    Created on : 17/02/2015, 06:55:52 AM
    Author     : felix
--%>
            ...
            <form>
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <a href="/SistemaEvaluacion/disenioActividad2.jsp?materia=<%=materias_vector.get(c)%>">
